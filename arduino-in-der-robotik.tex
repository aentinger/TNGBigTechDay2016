...
\begin{itemize}
	\item Bisherige IDII Plattform: \textbf{BASIC Stamp}
	\begin{itemize}
		\item \textbf{PIC} basierte $\mu{}$C-Platine mit integriertem BASIC-Interpreter
		\item Nachteile:
		\begin{itemize}
...
\end{itemize}
\begin{itemize}
	\item \textbf{Konsequenz:} Konzeption der \textbf{Hard- und Software}komponenten bestehenden \textbf{Arduino Plattform} in 2005
\end{itemize}
\end{frame}
%%----------------------------------------------------------------------------------------
