...
\begin{itemize}
	 \item Entwicklung des Arduino Konzepts durch \textbf{Massimo Banzi} und \textbf{David Cuartielles}\footnote{Weitere Teammitglieder: Tom Igoe, Gianluca Martino, David Mellis\cite{IEEE:2016:TheMakingOfArduino}} in 2005
\end{itemize}
\begin{itemize}
...
\begin{itemize}
	\item Bis 2005 wurden bei IDII die \textbf{BASIC Stamp} f\"ur Physical Computing Projekte eingesetzt.
	\begin{itemize}
		\item PIC basierte $\mu{}$C-Platine mit integriertem BASIC-Interpreter
		\item Nachteile:
		\begin{itemize}
...
\end{itemize}
\begin{itemize}
	\item \textbf{Konsequenz:} Konzeption der \textbf{Hard- und Software}komponenten bestehenden \textbf{Arduino Plattform}
\end{itemize}
\end{frame}
%%----------------------------------------------------------------------------------------
...
\begin{columns}
 ...
 \begin{itemize}
  \item Kosteng\"unstige $\mu$C-Board auf Basis von (zumeist 8-Bit) ATMEL Prozessoren
  \begin{itemize}
 ...
 \begin{itemize}
  ...
  \begin{itemize}
   ...
   \item SAM3X8E mit 32 Bit Cortex-M3 Core: \textbf{Due}
   \item ...
  \end{itemize}
 \end{itemize}
 \end{column}
...
\end{frame}
%%----------------------------------------------------------------------------------------
\begin{frame}[fragile]{Arduino Framework: Software (2)}
\begin{itemize}
 	\item \textbf{Abstrakte High-Level Befehle} erm\"oglichen Hardware-Zugriff ohne Detail-Kenntnisse des verwendeten $\mu$Cs
\end{itemize}
\begin{lstlisting}[frame=single, language=C]
...
\end{lstlisting}
\begin{itemize}
	\item \textbf{Bootloader} erm\"oglicht \textbf{einfache Programmierung der Arduino Boards}
	\begin{itemize}
		\item Kompilieren und Programmieren \"uber \textbf{Strg+U} oder \textbf{Upload Button}
	\end{itemize}
\end{itemize}
\end{frame}
%%----------------------------------------------------------------------------------------
