...
\begin{large}\textbf{Ziel}\end{large}
\begin{itemize}
	\item Den oder die gegnerischen Schaukampfroboter fahrunf\"ahig machen oder in die Arenagrube versenken. \href{./videos/schnauzer.mp4}{\beamergotobutton{Video}}
\end{itemize}
 \begin{figure}[H]
  \centering
...
\begin{frame}{Arduino-I/O-System: Verifikation \"Uberblick}
	\begin{itemize}
		\item \textbf{Verifikation des Gesamtsystems notwendig}
	\end{itemize}
	\begin{itemize}
		\item Gesamtsystem = C++ Library + Kommunikationsschnittstelle + Arduino Firmware $\rightarrow$ \textbf{End-to-End-Verifikation}
	\end{itemize}
	\begin{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item 2 x RC Servos (Kopf) (Puls-Weiten-Modulation)
	\end{itemize}
\end{itemize}
\end{frame}
%%----------------------------------------------------------------------------------------
